{
  ...
  "permissions": {
    ...
    "deny": [
      ...
      "Write(/var/log/**)",
      "Edit(/home/<agent>/.ssh/**)",
      "Edit(/home/<agent>/claude/.claude/projects/-home-<agent>-claude/memory/**)",
      "Edit(**/.env)",
      "Edit(**/.env.*)",
      "Edit(**/*.env)",
      "Edit(/etc/**)",
    ...
    "SessionStart": [
      {
        "hooks": [
          {
            "type": "command",
            "command": "/home/<agent>/workspace/scripts/hooks/<agent>-sessionstart-hook.py"
          }
        ]
      }
    ],
    "UserPromptSubmit": [
      {
        "hooks": [
          {
            "type": "command",
            "command": "/home/<agent>/workspace/scripts/hooks/<agent>-userprompt-hook.py"
          }
        ]
      }
    ],
    ...
    "PostToolUse": [
      {
        ...
        "hooks": [
          {
            "type": "command",
            "command": "/home/<agent>/workspace/scripts/hooks/<agent>-posttooluse-hook.py"
          }
        ]
      }
    ],
    ...
    "Notification": [
      {
        "hooks": [
          {
            "type": "command",
            "command": "/home/<agent>/workspace/scripts/hooks/<agent>-notification-hook.py"
          }
        ]
      }
    ],
    "PreCompact": [
      {
        "hooks": [
          {
            "type": "command",
            "command": "/home/<agent>/workspace/scripts/hooks/<agent>-precompact-hook.py"
          }
        ]
      }
    ]
